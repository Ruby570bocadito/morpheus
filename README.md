...
This project is licensed under the MIT License for educational purposes only. See [LICENSE](LICENSE) for details.

## 🙏 Acknowledgments

- Inspired by [Pesidious](https://github.com/CyberForce/Pesidious)
- PE manipulation using [LIEF](https://lief.quarkslab.com/)
- RL implementation based on [Stable-Baselines3](https://stable-baselines3.readthedocs.io/)

## 📧 Contact

For research inquiries: [Your Email]
